...
contract StargateAdapter is BaseAdapter {
    ...
    constructor(
        ...
        TOKEN_PRICE_FEED = AggregatorV3Interface(_tokenPriceFeed);
        ...
        PRECISION_MULTIPLIER = 10 ** (18 - decimals);
    }
    ...
    function value() public override view returns (uint estimatedValue, uint lps) {
        uint p = TOKEN_PRICE_FEED.getPrice(FEED_STALE_PRICE_INTERVAL);
