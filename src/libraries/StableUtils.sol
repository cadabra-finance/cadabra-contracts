...
library StableUtils {
    ...
    function amount0(
        ...
        _amount0 = _reserve0 - _y(_amount1 + _reserve1, xy, _reserve0, _base0, _base1);
    ...
    function amount1(
        ...
        _amount1 = _reserve1 - _y(_amount0 + _reserve0, xy, _reserve1, _base0, _base1);
        _amount1 = (_amount1 * _base1) / 1e18;
    }

    function _k(uint256 _x, uint256 _y, uint256 _base0, uint256 _base1) private pure returns (uint256) {
        _x = (_x * 1e18) / _base0;
        _y = (_y * 1e18) / _base1;
    ...
    function _y(uint256 x0, uint256 xy, uint256 y, uint256 _base0, uint256 _base1)
        private
        pure
        returns (uint256)
    {
