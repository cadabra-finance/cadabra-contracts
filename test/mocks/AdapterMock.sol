...
contract AdapterMock is BaseAdapter, StdAssertions {
    ...
    // TODO check swaps
    function compound(IBalancer.SwapInfo[] memory) external override onlyBalancer returns (uint leqBefore, uint leqAfter) {
    ...
    function ratios()
        ...
        view
        override
        returns (address[] memory tokens, uint[] memory _ratios)
    {}
